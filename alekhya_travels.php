...
<link href="https://fonts.googleapis.com/css?family=Arvo|Chicle|Indie+Flower|Lobster|Press+Start+2P" rel="stylesheet">
  ...
  <div class="container-fluid">
    ...
    <center><span style="background-color:red"><h1>WELCOME TO ALEKHYA TRAVELS</h1></span>
      <table>
        <tr>
    ...
    <table  border="4">
        ...
        <!-- <tr><td>AVAILABLE SEATS</td><td></td></tr>
        <tr><td>NO OF SEATS SELECTED</td><td></td></tr> -->
