...
<?php
		...
		$sqll="insert into details(uname,pass)values('$uname','$pass')";
		if($conn->query($sqll)==true){
// 			echo "<html><body style=background-im: url("."https://images.unsplash.com/photo-1494515843206-f3117d3f51b7?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=b09c21ac2a8db55f43f901226be1f901&auto=format&fit=crop&w=752&q=80".");
// ></html>";
				echo "<html>";
				echo "<body>";
				echo "<div class=jumbotron style=margin-left:450px>";
				echo "<center>YOU HAVE SUCCESSFULLY SIGNED UP<br>";
